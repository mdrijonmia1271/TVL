    ...
    public function ForgotPassword()
    {
        ...
        if ($this->form_validation->run() == true) {
            ...
            if ($valid == true) {
                ...
                $response ['status'] = true;
                $response['msg'] = 'Your OTP password use for change password';
                $msg='আপনার ওটিপি কোডঃ '."$random";
                send_sms($mobile,$msg);
...
//=========================== customer sign-up =========================
    ...
    /*function file_upload(){
        ...
        if(!empty($_FILES['report']['name'])){
            ...
            $path = '/var/www/html/icel/upload/job_report/' . 90;
            if (!is_dir($path)) {
            ...
            {
                $res['imageError'] =  $this->upload->display_errors();
            ...
            if ($support_type_id == 1 || $support_type_id == 2) {
                ...
                if ($valid_support == 1) {
                    ...
                    if (!empty($generate_ticket_no)) {
                        ...
                        $arr['status'] = 'ok';
                        $arr['ticket_no'] = $generate_ticket_no;
                        $arr['msg'] = 'Your ticket has been submitted. Ticket No. :' . $generate_ticket_no;
...
//================== customer logout =============================
    ...
    public function action()
    {
        ...
        if (!empty($auto_id && $engineer_id)) {
            ...
            $path = ROOT_IMG_URL.'upload/job_report/' . $ticket_details->srd_id. '/' . $ticket_details->job_report;
