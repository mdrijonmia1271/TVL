...
class Ticket extends My_Controller
{
    ...
    public function get_support_type_info()
    {
        ...
        $customer_id = $this->session->userdata('customer_auto_id');
        $data['support_type'] = $this->Mod_ticket->get_machine_supporttype_info($result_explode[0], $customer_id);
            ...
            if ($support_type_id == 1 || $support_type_id == 2) {
                ...
                if ($valid_support == 1) {
                    ...
                    if (!empty($generate_ticket_no)) {
                        ...
                        $message_details_manager = get_temp_details('CREATE_TICKET_MANAGER');
                        ...
                        $this->session->set_flashdata('generate_ticket_no', $generate_ticket_no[0]);
                    ...
                    $this->session->set_flashdata('flashError', 'Your Support Time Already Exists.');
                    redirect('sm/ticket/');
                }
...
//=========================== view customer ticket details ======================
    ...
    //================ customer comment on Eng. ==============================

    public function add_comment($id)
    {

        $data['ticket'] = $id;
        $this->load->view('sm/ticket/view_customer_comment', $data);
    ...
    public function comment_save()
    {
        if ($_POST) {
            ...
            $this->Mod_ticket->save_customer_comment(array('srd_id' => $id), $data);
