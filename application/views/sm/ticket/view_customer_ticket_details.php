                        ...
                        <table class="table table-bordered  table-condensed cf">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    ?>
                                    <?php echo $ticket_details_data->mc_name . " ( Model : " . $ticket_details_data->mc_model . $version . $serial . ")"; ?>
                            ...
                            <tr>
                                <th>Department :</th>
                                <td>
                                    <?= get_department_name_by_id($ticket_details_data->dep_ref_id); ?>
                                </td>
                            </tr>
                            <tr>
                                            ...
                                            <td>
                                                <?php if (!empty($service_engineer->picture)) { ?>
                                                    <img alt="img" width="60" height="40"
                                                         src="<?php echo base_url() . 'upload/service_engineer/' . $service_engineer->ser_eng_id . '/' . $service_engineer->picture ?>"/>
                                                <?php } else { ?>
                                                    <img alt="img" width="60" height="40"
