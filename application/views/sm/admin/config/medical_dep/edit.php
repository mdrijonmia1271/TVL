                ...
                <div class="position-center">
                    <div class="form">
                        ...
                        <form class="cmxform form-horizontal" method="post"
                              action="<?php echo base_url() . 'sm/admin_config/update/'; ?>">
                            <?php echo form_hidden(array('hidden_dep_id' => $edit->id)); ?>

                            <div class="form-group">
                                <label for="colorform-control_code" class="control-label col-lg-3">Department<span
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <select class="form-control" id="status" name="status">
                                        ...
                                        <option <?php if ($edit->status == '1') {
                                            echo 'selected';
                                        } ?> value="0">Active
                                        </option>
                                        <option <?php if ($edit->status == '0') {
                                            echo 'selected';
                                        } ?> value="1">In active
                                        </option>
