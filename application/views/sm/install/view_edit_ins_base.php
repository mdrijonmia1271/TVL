                    ...
                    <div class="form">
                        <form class="form-horizontal" id="insForm">
                                    ...
                                    <select class="form-control" id="dep_ref_id" name="dep_ref_id">
                                        ...
                                        <?php if (!empty($department)): ?>
                                            <?php foreach ($department as $c): ?>
                                                <option <?php if ($install->dep_ref_id == $c->id) { echo 'selected';} ?> value="<?= $c->id; ?>"><?= $c->name; ?></option>
                                            <?php endforeach; ?>
                                        <?php endif; ?>
                                    </select>
                                    <span class="help-block"></span>
                            ...
                            <div class="form-group">
                                <label class="col-lg-3 control-label" for="picture">Equipment Picture : </label>
                                <div class="col-lg-8">
                            ...
                            <?php if ( $su_type->su_type_id == 1 || $su_type->su_type_id == 2): ?>
                                <?php $start_date = date("d-m-Y", strtotime($su_type->su_start_date));  ?>
                                <?php $end_date = date("d-m-Y", strtotime($su_type->su_end_date));  ?>
                                <div id="amc">
                                    <div class="form-group required supp-date">
                                        ...
                                        <div class="col-lg-4">
                                            <input type="text" name="support_end"
                                                   placeholder="End Date" class="form-control stn"
                                ...
                                <div class="form-group after-add-more">
                                    <label class="col-lg-3 control-label" for="pmi">PMI</label>
                                    <div class="col-lg-7">
                                        <input type="text" name="pmi[]" id="pmi" class="form-control stn"
                                               placeholder="Enter PMI Schedule" readonly>
                                    </div>
                                    <button type="button" class="btn btn-primary btn-sm" id="pmi-add">Add More
                                    </button>
                                </div>

                                <?php if (!empty($pmi)): ?>
                                    <?php foreach ($pmi as $pmi_info): ?>
                                    <?php $pmi_date = date("d-m-Y", strtotime($pmi_info->pmi_date));  ?>
                                        <div class="form-group">
                                            <label class="col-lg-3 control-label" for="pmi">PMI</label>
                                            <div class="col-lg-7">
                                                <input type="text" name="pmi[]" id="pmi" class="form-control stn"
                                                       value="<?= $pmi_date; ?>" readonly>
                                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" name="woDate" id="woDate" placeholder="Enter Work order Date"
                                           class="form-control woDate" value="<?= $install->insb_work_order_date; ?>" readonly>
                                    <span class="help-block"></span>
                                </div>
                            </div>
                                ...
                                <div class="userTr">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <input type="text" name="uCell[]" id="uCell"
                                                               placeholder="Enter Cel Number" class="form-control"
                                                               value="<?= $user->user_cell_number; ?>"
                                                               maxlength="11">
                                                        <span class="help-block"></span>
                                    ...
                                    <?php elseif ($field != 0): ?>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-11">
                                                <div class="pull-right">
                                                    <button type="button" id="btnremove_<?= $user->user_id; ?>"
                                                            onclick="revome_field('<?= $user->user_id; ?>')"
                                                            class="btn btn-danger edit-remove">Remove
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
