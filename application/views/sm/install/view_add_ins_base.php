                        ...
                        <form class="form-horizontal" id="insForm">
                            ...
                            <div class="supp-date" hidden="hidden">
                                ...
                                <div class="form-group after-add-more">
                                    ...
                                    <button type="button" class="btn btn-primary btn-sm" id="pmi-add">Add More </button>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" name="woDate" id="woDate" placeholder="Enter Work order Date"
                                           class="form-control woDate" readonly>
                                    <span class="help-block"></span>
                                </div>
                            </div>
                            ...
                            <div class="form-group required">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" name="insDate" id="insDate"
                                           placeholder="Enter Installation Date" class="form-control insDate" readonly>
                                    <span class="help-block"></span>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-11">
                                        <div class="pull-right">
                                            <span id="remove"></span>
                                            <button id="add-more" type="button" class="btn btn-primary btn-sm ">Add
                                                More
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group">
                                <div class="col-lg-offset-3 col-lg-9">
                                    <button type="button" onclick="trv.install_base.create()" class="btn btn-success"
                                            id="btnSave">Submit
                                    </button>
                                </div>
                            </div>
