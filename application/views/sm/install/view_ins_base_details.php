                ...
                <div class="panel with-nav-tabs">
                    <div class="panel-heading tab-bg-dark-navy-blue" style="padding: 16px;">
                        <ul class="nav nav-tabs">
                            ...
                            <li><a href="#tab5success" data-toggle="tab">Picture</a></li>
                        </ul>
                    </div>
                    <div class="panel-body">
                        <div class="tab-content">
                            <div class="tab-pane fade in active" id="tab1success">
                                <div class="col-md-12 col-lg-12">
                                    ...
                                    <?php if (!empty($install->insb_report)): ?>
                                        <a href="<?php echo base_url('upload/install_base/' . $install->insb_id . '/' . $install->insb_report); ?>"
                                           class="btn btn-success" target="_blank">Installation Report</a>
                                    <?php endif; ?>
                                    <?php if (!empty($install->insb_acceptence_report)): ?>
                                        <a href="<?php echo base_url('upload/install_base/' . $install->insb_id . '/' . $install->insb_acceptence_report); ?>"
                                           class="btn btn-info" target="_blank">Acceptance Certificate</a>
                                    <?php endif; ?>
                                </div>
                            </div>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <?php if (!empty($start_date && $end_date)): ?>
                                            ...
                                            <?php if ($now >= $start_date && $now <= $end_date): ?>
                                                <td><?php format_change($start_date); ?></td>
                                                <td><?= format_change($end_date); ?></td>
                                            <?php else: ?>
                                                <td class="text-danger"><?= format_change($start_date); ?></td>
                                                <td class="text-danger"><?= format_change($end_date); ?></td>
                                            <?php endif; ?>

                                        <?php else: ?>

                                            <td class="text-primary">On Call</td>
                                            <td class="text-primary">On call</td>
                            ...
                            <div class="tab-pane fade" id="tab5success">
                                <?php if ($install->picture): ?>
                                    <div class="col-md-6">
                                        <div class="thumbnail">
                                            <img src="<?= base_url('upload/install_base/' . $install->insb_id . '/' . $install->picture) ?>"
                                                 alt="ALT NAME">
                                        </div>
                                    </div>
                                <?php endif; ?>
