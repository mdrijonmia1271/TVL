            ...
            <div class="panel-body">
                <form role="form" class="form-horizontal bucket-form" enctype="multipart/form-data" method="post"
                    ...
                    <div class="form-group">
                        ...
                        <!--<label for="code" class="col-sm-1 control-label col-lg-1">Eng. ID</label>
                        <div class="col-lg-3">
                    ...
                    <div class="form-group text-center">
                        <!--<label for="status" class="col-sm-1 control-label col-lg-2">Status</label>
                ...
                <div class="position-center1">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <th>Engineer Name</th>
                                <th>Engineer Mobile</th>
                                <th>Engineer Email</th>
                                <th>Total Request</th>
                                <th colspan="5">status</th>
                                <th colspan="<?php echo $rows_supp_type = num_of_rows_support_type(); ?>">Support Type
                                </th>
                            </tr>
                            ...
                            <?php if (!empty($record)): ?>
                                ...
                                <?php foreach ($record as $value): ?>
                                    <tr>
                                        ...
                                        <td><?php
                                            echo $total_request_enginner = total_request_enginner($value->ser_eng_id);
                                        ...
                                        <td><?php
                                            echo $get_engineer_status_pending = get_engineer_status_pending($value->ser_eng_id);
                                            $total_status_pending_sum = $get_engineer_status_pending + $total_status_pending_sum;
                                            ?>&nbsp;
                                        </td>
                                        <td><?php
                                            echo $get_engineer_status_working = get_engineer_status_working($value->ser_eng_id);
                                            $total_status_working_sum = $total_status_working_sum + $get_engineer_status_working;
                                            ?>&nbsp;
                                        </td>
                                        <td><?php
                                            echo $get_engineer_status_progress = get_engineer_status_progress($value->ser_eng_id);
                                            $total_status_progress_sum = $total_status_progress_sum + $get_engineer_status_progress;
                                            ?>&nbsp;
                                        </td>
                                        <td><?php
                                            echo $get_engineer_status_approve = get_engineer_status_approve($value->ser_eng_id);
                                            $total_status_approve_sum = $total_status_approve_sum + $get_engineer_status_approve;
                                            ?>&nbsp;
                                        </td>
                                        <td><?php
                                            echo $get_customer_status_cancel = get_customer_status_cancel($value->ser_eng_id);
                                        ...
                                        <?php foreach ($support_type_list as $val_supp_body) {
                                           ...
                                           //echo '<pre>'; print_r($val_supp_body);


                                            ?>
                                            <td><?php
                                                echo $get_total_support_type1 = get_total_support_type_engineer($value->ser_eng_id, $val_supp_body->service_type_id);
                    ...
                    <div class="table-responsive" style="display: none" id="smReport">
                        <table class="table table-bordered">
                            <thead>
                            <tr>
                                <th>Engineer Name</th>
...
/*                                        echo $get_total_support_type1 = get_total_support_type_engineer($value->ser_eng_id, $val_supp_body->service_type_id);
                                ...
                                <?php /*foreach ($priority_list as $val_priority_body) { */?>
                                    <td><?php
/*                                        echo $get_total_priority1 = get_total_priority_engineer($value->ser_eng_id, $val_priority_body->priority_id);
