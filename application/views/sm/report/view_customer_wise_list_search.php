        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <div class="position-center1">
                    ...
                    <table id="customerReport" class="table table-bordered table-striped table-condensed cf"
                           width="100%" border="5">
                        <thead class="cf">
                        <tr>
                        ...
                        if (!empty($search)) {
                            ...
                            foreach ($search as $key => $value) {
                                ...
                                <td><?php
                                    echo $get_customer_status_progress = get_customer_status_progress($value->send_from);
