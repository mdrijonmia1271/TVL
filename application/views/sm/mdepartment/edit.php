        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <div class="col-md-6 col-md-offset-2">
                    ...
                    <form method="post" action="<?php echo base_url('sm/mdepartment/update'); ?>">
                        <input type="hidden" name="hidden_dep_id" value="<?= $edit->id ?>">
                            ...
                            <select class="form-control" id="customer" name="customer">
                                ...
                                <?php if (!empty($customer)): ?>
                                    <?php foreach ($customer as $c): ?>
                                        <option <?php if ($c->customer_id == $edit->customer_id) {
                                            echo 'selected';
                            ...
                            <select class="form-control" id="department" name="department">
                                ...
                                <?php if (!empty($department)): ?>
                                    <?php foreach ($department as $d): ?>
                                        <option <?php if ($d->id == $edit->department_id) {
                                            echo 'selected';
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" class="form-control" id="phone" name="phone" value="<?= $edit->phone; ?>">
                        </div>
