    ...
    <div class="col-md-12 col-lg-12">
        ...
        <div class="row">
            <div class="col-md-12 col-lg-12">
                <section class="panel">
                    <header class="panel-heading">
                        <b>Total Customer Sub Users: <?= $total_rows; ?> </b>
                    </header>
                </section>
            </div>
            <?php if(count($record)):?>
                <div class="col-md-12">
                    <h2 class="alert alert-success text-center" style="margin-top: 0;"><?= $record[0]->name ?></h2>
                </div>
            <?php endif;?>
            <?php
            if (!empty($record)) : ?>
