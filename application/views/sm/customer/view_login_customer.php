...
<form class="form-signin" enctype="multipart/form-data" method="post" action="<?php echo base_url() . 'sm/login/customer_verify_login'; ?>">
   <?php
    ...
    <div class="login-wrap">
        ...
        <label class="checkbox text-center">
            <span class="text-right">
                <a data-toggle="modal" href="<?php echo base_url() . 'sm/cust_sign/forgot'; ?>" style="color: #000000; font-weight: 500"> Forgot Password?</a>
            </span>
        </label>

        <div class="registration">
            Don't have an account yet?
            <a class="" href="<?php echo base_url() . 'sm/cust_sign'; ?>" style="color: #fff;font-weight: 900;font-size: 16px;">
                Customer Signup
            </a>
        </div>
