                ...
                <div class="tab-content">
                    <div id="home" class="tab-pane active">
                        <table class="table table-bordered  table-condensed cf">
                            ...
                            <?php
                            $version = $ticket_details_data->insb_version ? ", Version : " . $ticket_details_data->insb_version : '';
                            $serial = $ticket_details_data->insb_serial ? ", Serial : " . $ticket_details_data->insb_serial : '';
                            ?>
                            <tr>
                                <th>Equipment/Item:</th>
                                <td><b><?= $ticket_details_data->mc_name . " ( Model :" . $ticket_details_data->mc_model . $version . $serial . ")"; ?></b></td>
                            </tr>
                            ...
                            <?php $upload_doc = 'upload/job_report/' . $ticket_details_data->srd_id . '/' . $ticket_details_data->job_report;?>
                            <?php if (file_exists($upload_doc)): ?>
                            <tr>
                                <th>Updated Job Report :</th>
                                <td>
                                    <a href="<?= base_url('upload/job_report/' . $ticket_details_data->srd_id . '/' . $ticket_details_data->job_report) ?>"
