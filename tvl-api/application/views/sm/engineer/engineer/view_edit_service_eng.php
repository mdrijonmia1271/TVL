...
<div class="row">
    ...
    ?>      
                ...
                <div class="form">
                    ...
                    <form  enctype="multipart/form-data"  class="cmxform form-horizontal " id="signupForm" method="post" action="<?php echo base_url() . 'sm/engineer/update'; ?>">
                       <?php echo form_hidden(array('hidden_ser_eng_id' => $edit->ser_eng_id));?>  
                   
                        <div class="form-group ">
                            <label for="name" class="control-label col-lg-3">Full Name<span style="color:red">&nbsp;*</span></label>
                            <div class="col-lg-6">
                                <?php
                        ...
                        <div class="form-group ">
                            ...
                            <label for="email" class="control-label col-sm-1">Email Address<span style="color:red">&nbsp;*</span></label>
                            <div class="col-lg-2">
                                <?php
                                $email_arry = array(
                                    'name' => 'email',
                   ...
                   <label for="Service Engineer code" class="control-label col-lg-1">Service Engineer Code<span style="color:red">&nbsp;*</span></label>
                <div class="col-lg-2">
                    <?php
                    $code_arry = array(
                    'name' => 'ser_eng_code',
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                ...
                                <?php if (!empty($edit->picture)) { ?>
                                    <img alt="img" width="60" height="40" src="<?php echo base_url() . 'upload/service_engineer/' . $edit->ser_eng_id . '/' . $edit->picture ?>"/>
                                <?php } else { ?>
