<?php $this->load->view('sm/home/view_login_header'); ?> 
      ...
      <form class="form-signin" enctype="multipart/form-data" method="post" action="<?php echo base_url() . 'sm/login/eng_verify_login'; ?>">
         <h2 class="form-signin-heading" style="background: #39b5aa!important;"><b>Engineer Sign In</b></h2>
        <div class="login-wrap">
            <div class="user-login-info">
                   <?php
                        ...
                        'id' => 'mobile',
                        'class' => "form-control",
                        'placeholder' => 'Enter Enginner Mobile',
                        //'required'=> 'required',
...
<!--            <label class="checkbox">
            ...
            <button class="btn btn-lg btn-login btn-block"  style="background: #e76b66!important;" type="submit">Sign in</button>
