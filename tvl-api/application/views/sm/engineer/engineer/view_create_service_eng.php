                ...
                <div class="form">
                    ...
                    <form  enctype="multipart/form-data"  class="cmxform form-horizontal " id="signupForm" method="post" action="<?php echo base_url() . 'sm/engineer/save'; ?>">
                        <div class="form-group ">
                            ...
                            <label for="ser_eng_code" class="control-label col-lg-3">Service Engineer Code<span style="color:red">&nbsp;*</span></label>
                            <div class="col-lg-6">
                                <?php
                                $eng_code_arry = array(
                                    'name' => 'ser_eng_code',
                                    'id' => 'ser_eng_code',
                                    'class' => "form-control",
                                    'placeholder' => 'Enter Enginner Code',
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6"><input  name= "image" id="exampleInputFile" type="file">
                            </div>
                        </div>
