                    ...
                    <tbody>
                        ...
                        foreach ($year_array as $key => $value) {
                            ...
                            <tr>
                                ...
                                <td><?php echo get_year_status_wise_total_ticket_for_eng($value,'P');?></td>
                                <td><?php echo get_year_status_wise_total_ticket_for_eng($value,'W');?></td>
                                <td><?php echo get_year_status_wise_total_ticket_for_eng($value,'A');?></td>
                                <td><?php echo get_year_status_wise_total_ticket_for_eng($value,'C');?></td>
                            </tr>
                            <?php
                        }
                        ?>
