                            ...
                            <section class="panel">
                                    ...
                                    <a href="#">
                                        ...
                                        <?php if (!empty($value->picture)) { ?>
                                            <img alt="img" width="60" height="40"
                                                 src="<?php echo base_url() . 'upload/customer_image/' . $value->customer_id . '/' . $value->picture ?>"/>
                                        <?php } else { ?>
                                            <img alt="img" width="60" height="40"
                                ...
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li><a href="javascript:;"> <i class="fa fa-comments-o"></i> <span
                                                    style="color: #003399;"> Ticket Pending  </span>
                                            <span class="badge label-primary pull-right r-activity"><?php echo get_customer_status_pending($value->customer_id); ?></span>
                                        </a>
                                    </li>

                                    <li><a href="javascript:;"> <i class="fa fa-bell-o"></i> <span
                                                    style="color: #712b71;">Ticket Working</span>
                                            <span class="badge label-info pull-right r-activity"><?php echo get_customer_status_working($value->customer_id); ?></span>
                                        </a>
                                    </li>
                                    ...
                                    <li>
                                        <a style="color: #fff;" class="btn btn-compose"
