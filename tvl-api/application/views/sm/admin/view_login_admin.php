...
<form class="form-signin" enctype="multipart/form-data" method="post" action="<?php echo base_url() . 'sm/login/admin_verify_login'; ?>">
   <?php
   ...
   <h2 class="form-signin-heading" style="background: #FF6C60;"><b>User Sign In</b></h2>
    <div class="login-wrap">
        <div class="user-login-info">
            <?php
            $login_name_arry = array(
                'name' => 'username',
                'id' => 'username',
                'class' => "form-control",
            ...
            echo form_input($login_name_arry);
            ?>
...
<!--        <label class="checkbox">
        ...
        <button class="btn btn-lg btn-login btn-block" style="background: lightsalmon;" type="submit">Sign in</button>
