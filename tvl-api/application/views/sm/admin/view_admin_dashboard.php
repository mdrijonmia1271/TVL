...
<div class="row">
	...
	if(!empty($customer_list_for_dashboard)){
		...
		$cus_total_ticket = $cus_total_ticket_pending+$cus_total_ticket_working +$cus_total_ticket_approve+$cus_total_ticket_cancel;
					...
					<div class="top-stats-panel">
						...
						<div class="bar-stats">
							<ul class="progress-stat-bar clearfix">
								<li data-percent="<?php echo $cus_total_ticket_pending_per;?>%"><span class="progress-stat-percent pink"></span></li>
                                <li data-percent="<?php echo $cus_total_ticket_working_per;?>%"><span class="progress-stat-percent yellow-b"></span></li>
								<li data-percent="<?php echo $cus_total_ticket_approve_per;?>%"><span class="progress-stat-percent green"></span></li>
								<li data-percent="<?php echo $cus_total_ticket_cancel_per;?>%"><span class="progress-stat-percent red-bg"></span></li>
							</ul>
							<ul class="bar-legend">
								<li><span class="bar-legend-pointer pink"></span> Pending ( <?php echo $cus_total_ticket_pending;?> )</li>
                                <li><span class="bar-legend-pointer yellow-b "></span> Working ( <?php echo $cus_total_ticket_working;?> )</li>
								<li><span class="bar-legend-pointer green"></span> Complete ( <?php echo $cus_total_ticket_approve;?> )</li>
								<li><span class="bar-legend-pointer red-bg"></span> Cancel ( <?php echo $cus_total_ticket_cancel;?> )</li>
							</ul>
							<div class="daily-sales-info">
								<span class="sales-label">Total Ticket : </span><span class="sales-count"><?php echo $cus_total_ticket;?> </span>
							</div>
						</div>
					</div>
				</div>
                        ...
                        <div class="top-stats-panel">
                            ...
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li><a href="javascript:;"> <i class="fa fa-cogs"></i> <span style="color: #a48ad4;">Ticket Working </span>
                                        <span class="badge label-success pull-right r-activity" style="background-color:#a48ad4;"><?php echo $ticket_list_daily_pending; ?></span>
                                    </a>
                                </li>
                        ...
                        <div class="top-stats-panel">
                            <div class="bar-stats">
                                <ul class="progress-stat-bar clearfix">
                                    ...
                                    $total_ticket_list_monthly = $ticket_list_monthly_pending+$ticket_list_monthly_working+$ticket_list_monthly_approve+$ticket_list_monthly_cancel;
                                    ...
                                    <li data-percent="<?php echo $ticket_list_monthly_working_per;?>%"><span class="progress-stat-percent yellow-b"></span></li>
                                    <li data-percent="<?php echo $ticket_list_monthly_approve_per;?>%"><span class="progress-stat-percent green"></span></li>
                                    <li data-percent="<?php echo $ticket_list_monthly_cancel_per;?>%"><span class="progress-stat-percent red-bg"></span></li>
                                </ul>
                                <ul class="bar-legend">
                                    <li><span class="bar-legend-pointer pink"></span> Pending ( <?php echo $ticket_list_monthly_pending;?> )</li>
                                    <li><span class="bar-legend-pointer yellow-b"></span> Working ( <?php echo $ticket_list_monthly_approve;?> )</li>
                                    <li><span class="bar-legend-pointer green"></span> Complete ( <?php echo $ticket_list_monthly_working;?> )</li>
                                    <li><span class="bar-legend-pointer red-bg"></span> Cancel ( <?php echo $ticket_list_monthly_cancel;?> )</li>
                                </ul>
                                <div class="daily-sales-info">
