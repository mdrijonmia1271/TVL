            ...
            <div class="panel-body">
                <div class="position-center">
                    <div class="form">
                        ...
                        <form  class = "cmxform form-horizontal"  enctype="multipart/form-data" method="post" action="<?php echo base_url() . 'sm/admin_config/save_priority'; ?>">
