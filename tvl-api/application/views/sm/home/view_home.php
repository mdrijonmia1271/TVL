                ...
                <div class="navbar-header">
                    ...
                    <div class="brand">
                        <a href="index.html" class="logo">
                            <img src="<?php echo base_url() . 'smdesign/'; ?>images/Logo.png" alt="">
                        </a>
                    </div>
                    <!--logo end-->
                    <!--logo end-->
                    <div class="horizontal-menu navbar-collapse collapse ">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="basic_table.html">Profile</a></li>
                            <li class="active"><a href="#">Report</a></li>


                            <li class="dropdown">
                                <a data-toggle="dropdown" data-hover="dropdown" class="dropdown-toggle" href="#">Admin<b class=" fa fa-angle-down"></b></a>
                                <ul class="dropdown-menu">
                                    <li><a href="general.html">Add</a></li>
                                    <li><a href="buttons.html">List</a></li>
                                    <li><a href="font_awesome.html">Report</a></li>
                                </ul>
                            </li>
                            <li class="dropdown">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="blank.html">Generate</a></li>
                                    <li><a href="boxed_page.html">Assign</a></li>
                                    <li><a href="profile.html">Report</a></li>
