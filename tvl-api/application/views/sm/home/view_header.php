...
<html lang="en">
    <head>
        ...
        <link href="<?php echo base_url() . 'smdesign/'; ?>css/style-responsive.css" rel="stylesheet" />
               ...
               <!--dynamic table-->
<!--      <link href="<?php echo base_url() . 'smdesign/'; ?>css/demo_page.css" rel="stylesheet" />
      <link href="<?php echo base_url() . 'smdesign/'; ?>css/demo_table.css" rel="stylesheet" />
      <link rel="stylesheet" href="<?php echo base_url() . 'smdesign/'; ?>css/DT_bootstrap.css" />-->
