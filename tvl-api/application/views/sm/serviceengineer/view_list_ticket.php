                ...
                <form role="form" class="form-horizontal bucket-form" enctype="multipart/form-data" method="post"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-12">
                            <div class="row">
                                <br>
                                <!--                                <label for="inputSuccess" class="col-sm-1 control-label col-lg-1">Task</label>
                                <div class="col-lg-3"  placeholder="Status">
                                    <?php
                                /* $customer_auto_id = $this->session->userdata('customer_auto_id');
                                 $service_task_name_array = get_service_task_name_array_dropdown($customer_auto_id);
                                 $id_ref_task_id_array = 'id ="ref_task_id" class="form-control"';
                                 echo form_dropdown('ref_task_id', $service_task_name_array, set_value('ref_task_id'), $id_ref_task_id_array);
                                 *
                                 */
                                ?>
                                </div>-->
