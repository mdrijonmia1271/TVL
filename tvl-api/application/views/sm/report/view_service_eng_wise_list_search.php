    ...
    <div class="col-sm-12">
        <section class="panel">
            ...
            <div class="panel-body">
                <form role="form" class="form-horizontal bucket-form" enctype="multipart/form-data" method="post" action="<?php echo base_url() . 'sm/report/service_eng_wise_list_search'; ?>">
                    <div class="form-group">

                        <div class="col-lg-12">
                            <div class="row"> 

                                <label for="name" class="col-sm-1 control-label col-lg-1"> Support Eng Name</label>
                                <div class="col-lg-4">
                                    <?php
                                ...
                                <label for="code" class="col-sm-1 control-label col-lg-1">Support Eng. Code</label>
                                <div class="col-lg-4">
...
//                echo '<pre>';   print_r($search);exit;
                                foreach ($search as $key => $value) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php
                                            echo $get_total_priority1 = get_total_priority_engineer($value->send_to,$val_priority_body->priority_id);
