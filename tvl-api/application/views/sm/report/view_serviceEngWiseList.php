        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form role="form" class="form-horizontal bucket-form" enctype="multipart/form-data" method="post"
                      action="<?php echo base_url() . 'sm/report/serviceEngWiseListsearch'; ?>">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <input id="da-from-datepicker" type="text" name="date_from" placeholder="Date Form"
                                           class="form-control"/>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <input id="da-to-datepicker" type="text" name="date_to" placeholder="Date To"
                                           class="form-control"/>
                                </div>
