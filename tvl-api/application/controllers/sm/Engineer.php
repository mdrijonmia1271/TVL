...
class Engineer extends My_Controller{
    ...
    function add_serviceEng(){
      ...
      function save() {
        ...
        $this->form_validation->set_rules('mobile', 'Mobile', 'required|callback_validate_uniqe_mobile|integer|max_length[16]');
...
//        $this->form_validation->set_rules('contact_add_upazila', 'Upazila', 'required');
    ...
    function records() {
        ...
        $this->data['total_rows'] = $this->Mod_engineer->service_engineer_total_rows();
